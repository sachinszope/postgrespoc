...
import com.gooru.services.impl.JDBCGooruUserService;

@Path("/gooru/jdbc-postgres")
public class JDBCGooruRest {
	GooruUserService gooruUserService = new JDBCGooruUserService();
